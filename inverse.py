...
class Inverse:
    ...
    def input_matrix(self):
        ...
        Button(self.frame_inverse_input, text="Enter", width=8, command=get_mat).grid(row=self.m_height.get() + 10,
                                                                                      column=1)
    ...
    def __init__(self):
        ...
        Label(self.frame_inverse_menu, text='Enter matrix length:').grid(row=3, column=1)
        Label(self.frame_inverse_menu, text='Enter matrix height:').grid(row=4, column=1)
        ...
        self.m_length.set(2)
        self.m_height.set(2)
        OptionMenu(self.frame_inverse_menu, self.m_length, *range(2, 11)).grid(row=3, column=2)
        OptionMenu(self.frame_inverse_menu, self.m_height, *range(2, 11)).grid(row=4, column=2)
